...
Ecore.Editor.MetaBrowserView = Backbone.View.extend({
    ...
    render: function() {
        ...
        var view = new Ecore.Editor.EModelElementColumnView({ model: packages, browser: this });
...
Ecore.Editor.EModelElementColumnView = Backbone.View.extend({
    ...
    render: function() {
        ...
        _.each(this.model, function(m) {
            var view = new Ecore.Editor.EModelElementRowView({ model: m, parent: this, browser: this.browser });
...
Ecore.Editor.EModelElementRowView = Backbone.View.extend({
    ...
    showContent: function() {
        ...
        if (this.contents.length > 0) {
            this.contentView = new Ecore.Editor.EModelElementColumnView({ model: this.contents, browser: this.browser });
